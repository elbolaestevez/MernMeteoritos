...
function EditNeas() {
  ...
  const onSubmit = async (data) => {
    ...
    const encoded=encodeURIComponent(designation);

    console.log("llego",designation);
    const res = await axios.put(`/api/astronomy/neas/${encoded}`,data)
