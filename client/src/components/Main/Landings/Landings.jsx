  ...
  const fetchData = async () => {
    try {
      ...
      const resp = await axios.get(
        `/api/astronomy/landings/mass/${inputmass}`)
        ...
        const resp = await axios.get(
          `/api/astronomy/landings/class/${search}`)
          const data = await resp.data;
        ...
        //  console.log(inputmass);
        const resp = await axios.get(
          `/api/astronomy/landings?minimum_mass=${minmass}`)
          const data = await resp.data;
        ...
        const resp = await axios.get(
          `/api/astronomy/landings?minimum_mass=0`
        );
        const data = await resp.data;
